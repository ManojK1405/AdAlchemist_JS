        ...
        <div className="min-h-screen text-white p-6 md:p-12 mt-28 selection:bg-cyan-500/30">
            <div className="max-w-7xl mx-auto">
                <header className="mb-16 relative">
                    <div className="flex items-center gap-2 text-cyan-400 text-xs font-bold uppercase tracking-[0.3em] mb-4">
                        <Sparkles size={14} />
                        Showcase
                    </div>
                    <h1 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter">Community <span className="text-cyan-500">Hall.</span></h1>
                    ...
                    <div className="flex items-center gap-4 mb-8 border-b border-white/10 pb-4">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-xl transition ${filter === 'recent' ? 'bg-cyan-600 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}
                        >
                            <Clock size={16} />
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-xl transition ${filter === 'trending' ? 'bg-cyan-600 text-white' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}
                        >
                            <TrendingUp size={16} />
