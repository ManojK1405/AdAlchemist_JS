        ...
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    ...
                    description="Our AI turns your ideas into reality, making it easy to create stunning visuals in seconds. Experience the power of AI-driven design."
                />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {featuresData.map((feature, i) => (
                        ...
                        >
                            <div className="w-12 h-12 rounded-lg bg-cyan-900/20 flex items-center justify-center mb-4">
                                {feature.icon}
                            </div>
